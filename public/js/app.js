...
var staticRenderFns = [
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticStyle: { "text-align": "center" } }, [
      _c("h1", [_vm._v("PLESE LOGIN TO CONTINUE")])
    ])
  }
]
render._withStripped = true
      ...
      _c(
        ...
        [
          _c("input", {
            ...
            attrs: { name: "email", placeholder: "ORGANIZATION NAME" },
    ...
    _c("div", { staticClass: "container" }, [
      _c("span", [
        _c(
          ...
          [_c("router-link", { attrs: { to: "/" } }, [_vm._v("CSRI")])],
          1
        )
      ]),
      _vm._v(" "),
      ...
      !_vm.show()
        ? _c("span", { on: { click: _vm.logout } }, [
            _c(
              ...
              [_c("router-link", { attrs: { to: "" } }, [_vm._v("LOGOUT")])],
              1
            )
          ])
        : _vm._e()
...
/* harmony import */ var _helpers_Storage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers/Storage */ "./resources/js/helpers/Storage.js");
/* harmony import */ var _helpers_Token__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./helpers/Token */ "./resources/js/helpers/Token.js");
...
window.Storage = _helpers_Storage__WEBPACK_IMPORTED_MODULE_5__["default"];
window.Token = _helpers_Token__WEBPACK_IMPORTED_MODULE_6__["default"];
...
function () {
  ...
  _createClass(Storage, [{
    ...
    key: "store",
    value: function store(user, token, usertype) {
      this.setToken(token);
      this.setUser(user);
    }
  }, {
...
function () {
  ...
  _createClass(Token, [{
    ...
    value: function isAdmin(token) {
      ...
      if (payload) {
        return payload.usr == 'admin' ? true : false;
      }
...
function () {
  ...
  _createClass(User, [{
    ...
    value: function isAdmin() {
      if (this.hasToken()) {
        var access_token = Storage.getToken();
    ...
    value: function hasToken() {
      var StoredToken = Storage.getToken();
    ...
    value: function id() {
      if (this.loggedIn()) {
        var payload = Token.payload(Storage.getToken());
        return payload.sub;
      }
    }
  }]);
...
__webpack_require__(/*! /home/hussnain/WebDev/CSRI/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/hussnain/WebDev/CSRI/resources/sass/index.scss */"./resources/sass/index.scss");
